...
class TradingBot {
  constructor(provider, wallet, poolAddress, wethAddress, usdcAddress, swapHelperAddress = null) {
    ...
    if (swapHelperAddress) {
      this.swapHelperContract = new ethers.Contract(swapHelperAddress, SWAP_HELPER_ABI, wallet);
